 ...
 * @author dosen
 */
public final class RMCariJumlahObatMeso extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariJumlahObatMeso(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Tanggal","Jam","Obat Diberikan","Dosis","Sedian"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariJumlahObatMeso dialog = new RMCariJumlahObatMeso(new javax.swing.JFrame(), true);
