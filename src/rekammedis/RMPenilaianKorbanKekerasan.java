...
public final class RMPenilaianKorbanKekerasan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-02-2026 20:16:57" }));
    ...
    private void BtnDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokterActionPerformed
        DlgCariPegawai pemeriksa=new DlgCariPegawai(null,false);
    ...
    */
    ...
    public void isCek(){
        ...
        if(akses.getjml2()>=1){
            ...
            NmDokter.setText(Sequel.CariPegawai(KdDokter.getText()));
        }            
    }
