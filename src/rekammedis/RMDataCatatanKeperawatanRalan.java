...
public final class RMDataCatatanKeperawatanRalan extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Valid.textKosong(KdPetugas,"Uraian");
        }else{
    ...
    private void UraianKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_UraianKeyPressed
        Valid.pindah2(evt,KdPetugas,BtnSimpan);
    ...
    */
    ...
    private void ganti() {
        if(Sequel.mengedittf("catatan_keperawatan_ralan","tanggal=? and jam=? and no_rawat=?","no_rawat=?,tanggal=?,jam=?,uraian=?,nip=?",8,new String[]{
            ...
            Uraian.getText(),KdPetugas.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),6).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),7).toString(),
    ...
    private void simpan() {
        if(Sequel.menyimpantf("catatan_keperawatan_ralan","?,?,?,?,?","Data",5,new String[]{
            Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),TNoRw.getText(),Uraian.getText(),KdPetugas.getText()
        })==true){
            tabMode.addRow(new Object[]{
                ...
                Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),Uraian.getText(),KdPetugas.getText(),NmPetugas.getText()
            });
            LCount.setText(""+tabMode.getRowCount());
            emptTeks();
        } 
