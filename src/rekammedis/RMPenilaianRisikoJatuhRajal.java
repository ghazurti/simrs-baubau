...
public final class RMPenilaianRisikoJatuhRajal extends javax.swing.JDialog {
    ...
    public RMPenilaianRisikoJatuhRajal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MnCetakFormulir.setText("Formulir Penilaian Risiko Jatuh Rawat Jalan");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Risiko Jatuh Pasien Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Sequel.queryu2tf("delete from penilaian_risiko_jatuh_rajal where no_rawat=?",1,new String[]{TNoRw.getText()});
        if(Sequel.menyimpantf2("penilaian_risiko_jatuh_rajal",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",20,
                new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(JOptionPane.showConfirmDialog(null,"Yakin data mau dihapus?","Konfirmasi",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
            if(Sequel.queryu2tf("delete from penilaian_risiko_jatuh_rajal where no_rawat=?",1,new String[]{TNoRw.getText()})==true){
                tampil(); emptyTeks();
            }
        }
    }
    ...
    private void ambilData(String norawat){
        ...
        try{
            psd = koneksi.prepareStatement(
              ...
              + "from penilaian_risiko_jatuh_rajal l "
    ...
    private void cetakNoRawat(String norawat){
        try{
            ...
            Valid.MyReportqrypdf("rptPenilaianRisikoJatuhRajal.jasper","report","::[ Penilaian Risiko Jatuh Rawat Jalan ]::",
