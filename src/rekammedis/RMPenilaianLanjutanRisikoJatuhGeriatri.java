    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_lanjutan_resiko_jatuh_geriatri","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",28,new String[]{
                ...
                SkalaResiko11.getSelectedItem().toString(),NilaiResiko11.getText(),NilaiResikoTotal.getText(),HasilSkrining.getText(),Saran.getText(),KdPetugas.getText()
            })==true){
                tabMode.addRow(new Object[]{
                    ...
                    Saran.getText(),KdPetugas.getText(),NmPetugas.getText()
                });
                emptTeks();
    ...
    */
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_lanjutan_resiko_jatuh_geriatri","tanggal=? and no_rawat=?","no_rawat=?,tanggal=?,penilaian_jatuh_skala1=?,penilaian_jatuh_nilai1=?,"+
                ...
                KdPetugas.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),5).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){
