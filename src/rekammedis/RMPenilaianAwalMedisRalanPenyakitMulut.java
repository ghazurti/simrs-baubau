/*
 * Asesmen Medis Ralan Penyakit Mulut
 */
 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRalanPenyakitMulut extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRalanPenyakitMulut(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengkajian Awal Medis Rawat Jalan Penyakit Mulut ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-02-2026 19:05:07" }));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                File f = new File("DataPenilaianAwalMedisRalanPenyakitMulut.html");            
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRalanPenyakitMulut.jasper","report","::[ Laporan Pengkajian Awal Medis Rawat Jalan Penyakit Mulut ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ralan_penyakit_mulut.tanggal,"+
                "penilaian_medis_ralan_penyakit_mulut.kd_dokter,penilaian_medis_ralan_penyakit_mulut.anamnesis,penilaian_medis_ralan_penyakit_mulut.hubungan,penilaian_medis_ralan_penyakit_mulut.keluhan_utama,"+
                "penilaian_medis_ralan_penyakit_mulut.rps,penilaian_medis_ralan_penyakit_mulut.rpk,penilaian_medis_ralan_penyakit_mulut.alergi,penilaian_medis_ralan_penyakit_mulut.keadaan,"+
                "penilaian_medis_ralan_penyakit_mulut.kesadaran,penilaian_medis_ralan_penyakit_mulut.nyeri,penilaian_medis_ralan_penyakit_mulut.td,penilaian_medis_ralan_penyakit_mulut.nadi,"+
                "penilaian_medis_ralan_penyakit_mulut.suhu,penilaian_medis_ralan_penyakit_mulut.rr,penilaian_medis_ralan_penyakit_mulut.bb,penilaian_medis_ralan_penyakit_mulut.tb,"+
                "penilaian_medis_ralan_penyakit_mulut.status_nutrisi,penilaian_medis_ralan_penyakit_mulut.kulit,penilaian_medis_ralan_penyakit_mulut.keterangan_kulit,penilaian_medis_ralan_penyakit_mulut.kepala,"+
                "penilaian_medis_ralan_penyakit_mulut.keterangan_kepala,penilaian_medis_ralan_penyakit_mulut.mata,penilaian_medis_ralan_penyakit_mulut.keterangan_mata,penilaian_medis_ralan_penyakit_mulut.leher,"+
                "penilaian_medis_ralan_penyakit_mulut.keterangan_leher,penilaian_medis_ralan_penyakit_mulut.kelenjar,penilaian_medis_ralan_penyakit_mulut.keterangan_kelenjar,penilaian_medis_ralan_penyakit_mulut.dada,"+
                "penilaian_medis_ralan_penyakit_mulut.keterangan_dada,penilaian_medis_ralan_penyakit_mulut.perut,penilaian_medis_ralan_penyakit_mulut.keterangan_perut,penilaian_medis_ralan_penyakit_mulut.ekstremitas,"+
                "penilaian_medis_ralan_penyakit_mulut.keterangan_ekstremitas,penilaian_medis_ralan_penyakit_mulut.wajah,penilaian_medis_ralan_penyakit_mulut.intra,penilaian_medis_ralan_penyakit_mulut.gigigeligi,"+
                "penilaian_medis_ralan_penyakit_mulut.lab,penilaian_medis_ralan_penyakit_mulut.rad,penilaian_medis_ralan_penyakit_mulut.penunjang,penilaian_medis_ralan_penyakit_mulut.diagnosis,"+
                "penilaian_medis_ralan_penyakit_mulut.diagnosis2,penilaian_medis_ralan_penyakit_mulut.permasalahan,penilaian_medis_ralan_penyakit_mulut.terapi,penilaian_medis_ralan_penyakit_mulut.tindakan,"+
                "penilaian_medis_ralan_penyakit_mulut.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ralan_penyakit_mulut on reg_periksa.no_rawat=penilaian_medis_ralan_penyakit_mulut.no_rawat "+
                "inner join dokter on penilaian_medis_ralan_penyakit_mulut.kd_dokter=dokter.kd_dokter where penilaian_medis_ralan_penyakit_mulut.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanPenyakitMulut dialog = new RMPenilaianAwalMedisRalanPenyakitMulut(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ralan_penyakit_mulut on reg_periksa.no_rawat=penilaian_medis_ralan_penyakit_mulut.no_rawat "+
                        "inner join dokter on penilaian_medis_ralan_penyakit_mulut.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ralan_penyakit_mulut.tanggal between ? and ? order by penilaian_medis_ralan_penyakit_mulut.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ralan_penyakit_mulut.tanggal,"+
                        "penilaian_medis_ralan_penyakit_mulut.kd_dokter,penilaian_medis_ralan_penyakit_mulut.anamnesis,penilaian_medis_ralan_penyakit_mulut.hubungan,penilaian_medis_ralan_penyakit_mulut.keluhan_utama,"+
                        ...
                        "inner join penilaian_medis_ralan_penyakit_mulut on reg_periksa.no_rawat=penilaian_medis_ralan_penyakit_mulut.no_rawat "+
                        "inner join dokter on penilaian_medis_ralan_penyakit_mulut.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ralan_penyakit_mulut.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ralan_penyakit_mulut.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ralan_penyakit_mulut.tanggal");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_awal_medis_ralan_penyakit_mulut());
        BtnHapus.setEnabled(akses.getpenilaian_awal_medis_ralan_penyakit_mulut());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ralan_penyakit_mulut());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ralan_penyakit_mulut where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ralan_penyakit_mulut","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpk=?,alergi=?,keadaan=?,kesadaran=?,nyeri=?,td=?,nadi=?,suhu=?,rr=?,bb=?,"+
    ...
    private void simpan() {
        if(Sequel.menyimpantf("penilaian_medis_ralan_penyakit_mulut","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",47,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPK.getText(),Alergi.getText(),Keadaan.getSelectedItem().toString(),Kesadaran.getSelectedItem().toString(),Nyeri.getSelectedItem().toString(),TD.getText(),Nadi.getText(), 
                Suhu.getText(),RR.getText(),BB.getText(),TB.getText(),StatusNutrisi.getText(),Kulit.getSelectedItem().toString(),KeteranganKulit.getText(),Kepala.getSelectedItem().toString(),KeteranganKepala.getText(), 
                Mata.getSelectedItem().toString(),KeteranganMata.getText(),Leher.getSelectedItem().toString(),KeteranganLeher.getText(),Kelenjar.getSelectedItem().toString(),KeteranganKelenjar.getText(),Dada.getSelectedItem().toString(), 
