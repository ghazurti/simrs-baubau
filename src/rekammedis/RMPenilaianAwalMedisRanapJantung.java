...
public final class RMPenilaianAwalMedisRanapJantung extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026 06:19:54" }));
    ...
    */
    ...
    private void autoFillDariSOAP() {
        try {
            koneksi=koneksiDB.condb();
            ps=koneksi.prepareStatement(
                "select tensi,berat,tinggi,suhu_tubuh,nadi,respirasi,keluhan,alergi from pemeriksaan_ranap "+
